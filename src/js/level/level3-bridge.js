	...
	*/
	...
	materials: {
		m0: {
			type: "L",
			color: 0x818b89,
			mapId: "../src/img/level/texture0.jpg"
		},
		m1: {
			type: "L",
			color: 0x9ba4a3
		...
		m3: {
			type: "L",
			color: 0xffffff,
			mapId: "../src/img/level/level3/level3ground.png"
		},
		m4: {
			type: "B",
			color: 0xffffff,
			opacity: 0,
			mapId: "../src/img/level/null.png"
		},
		m5: {
			type: "L",
			color: 0x818b89,
			mapId: "../src/img/level/endPoint.png"
		}
	},
	textures: [ 
		"../src/img/level/border.png", "../src/img/level/level3/level3ground.png", 
		"../src/img/level/null.png", "../src/img/level/endPoint.png"
	],
	lights: [ {
			key: "areaLight",
			color: 0x666666,
