var map = {
	...
	materials: {
		...
		m3: {
			type: "L",
			color: 0xffffff,
			mapId: "../src/img/level/level4/level4ground.png"
		},
		m4: {
			type: "B",
			color: 0xdad282,
	...
	textures: [ "../src/img/level/texture0.jpg", 
		"../src/img/level/border.png",
		"../src/img/level/level4/level4ground.png", 
		"../src/img/level/null.png", 
		"../src/img/level/endPoint.png"
	],
	lights: [ {
			key: "areaLight",
			color: 0x666666,
